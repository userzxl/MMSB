	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				<div class="com-logo" style="float:left;padding:0px 3px;background-color:#fff"><img style ="height:50px" src="${ctxStatic}/images/logo.png" /></div>
	    ...
	    <div class="container-fluid">
						...
						<c:if test="${menu.parent.id eq '1'&&menu.isShow eq '1'}">
							...
							<div class="accordion-heading" id="menu">
								<c:if test="${empty menu.href}">
									...
									<a class="accordion-toggle menu" data-href="${ctx}/sys/menu/tree?parentId=${menu.id}" href="javascript:"  title=""   data-id="${menu.id}"><span>${menu.name}</span></a>
								</c:if>	
								<c:if test="${not empty menu.href}">
		    ...
		    <div id="footer" class="row-fluid">
	            Copyright &copy; 2012-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} - Powered By <a href="http://jeesite.com" target="_blank">Kosney</a> ${fns:getConfig('version')}
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
